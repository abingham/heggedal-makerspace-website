...
BLOG_AUTHOR = "Austin Bingham"  # (translatable)
BLOG_TITLE = "Heggedal Makerspace"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://heggedal-makerspace.no/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://heggedal-makerspace.no/"
BLOG_EMAIL = "austin.bingham@gmail.com"
BLOG_DESCRIPTION = "Heggedal Makerspace"  # (translatable)
...
NAVIGATION_LINKS = {
    ...
    "nb": (
        ("/nb/archive.html", "Arkiv"),
        ("/nb/categories/", "Merker"),
        ("/nb/rss.xml", "RSS-nyhetskanal"),
    ),
}
